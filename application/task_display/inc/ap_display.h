...
typedef struct
{
    INT32U ldw_dis_LT_alarmP_X;
    INT32U ldw_dis_LT_alarmP_Y;
    INT32U ldw_dis_LB_alarmP_X;
    INT32U ldw_dis_LB_alarmP_Y;
    INT32U ldw_dis_LTP_X;
    INT32U ldw_dis_LTP_Y;
    INT32U ldw_dis_LBP_X;
    INT32U ldw_dis_LBP_Y;

    INT32U ldw_dis_RT_alarmP_X;
    INT32U ldw_dis_RT_alarmP_Y;
    INT32U ldw_dis_RB_alarmP_X;
    INT32U ldw_dis_RB_alarmP_Y;
    INT32U ldw_dis_RTP_X;
    INT32U ldw_dis_RTP_Y;
    INT32U ldw_dis_RBP_X;
    INT32U ldw_dis_RBP_Y;
} LDW_DISPLAY;
