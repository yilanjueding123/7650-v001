...
void TFT_ILI9341_Init(void)
{
    ...
    ILI9341_WR_Parameter(0x70); // duibidu: 0x68 5.496v
    ...
    */
    ...
    ILI9341_WR_COMD(0x36); // Memory Access Control
    //	ILI9341_WR_Parameter (0x08);    // ÆÁÄ»Ðý×ª my,mx,mv,ml,BGR,mh,0.0
    ILI9341_WR_Parameter (0x28);    // ÆÁÄ»Ðý×ª my,mx,mv,ml,BGR,mh,0.0
